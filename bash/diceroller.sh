...
echo "Rolling a pair of 5 six-sided dice: $(( RANDOM % 6 + 1)),$(( RANDOM % 6 + 1 )),$(( RANDOM % 6 + 1)),$(( RANDOM % 6 + 1)),$(( RANDOM % 6 + 1)) rolled"
echo "Rolling a pair of 20 sided dice: $(( RANDOM % 20 + 1)) rolled"
